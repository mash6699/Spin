...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        PoolDao.createTable(db, ifNotExists);
        EquipmentDao.createTable(db, ifNotExists);
        dealersDao.createTable(db, ifNotExists);
        statesDao.createTable(db, ifNotExists);
        countriesDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        UserDao.dropTable(db, ifExists);
        PoolDao.dropTable(db, ifExists);
        EquipmentDao.dropTable(db, ifExists);
        dealersDao.dropTable(db, ifExists);
        statesDao.dropTable(db, ifExists);
        countriesDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(PoolDao.class);
        registerDaoClass(EquipmentDao.class);
        registerDaoClass(dealersDao.class);
        registerDaoClass(statesDao.class);
        registerDaoClass(countriesDao.class);
    }
