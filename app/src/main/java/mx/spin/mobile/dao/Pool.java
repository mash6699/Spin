...
public class Pool implements Parcelable  {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeString(pool_name);
        dest.writeString(pool_customer);
        dest.writeString(pool_address);
        dest.writeString(pool_form);
        dest.writeString(pool_category);
        dest.writeString(pool_use);
        dest.writeString(pool_type);
        dest.writeString(pool_rotation);
        dest.writeString(pool_volume);
        dest.writeString(pool_um);
        dest.writeString(pool_register);
        dest.writeString(pool_modify);
        dest.writeString(pool_delete);
        dest.writeString(pool_status);
